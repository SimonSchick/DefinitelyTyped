declare module 'fs' {
    ...
    export function readdir(
        path: PathLike,
        options: ObjectEncodingOptions & { withFileTypes?: false } | BufferEncoding | undefined | null,
    ...
    export namespace readdir {
         ...
         * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
         */
        function __promisify__(path: PathLike, options?: ObjectEncodingOptions & { withFileTypes?: false } | BufferEncoding | null): Promise<string[] | Buffer[]>;
     ...
     * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
     */
    export function readdirSync(path: PathLike, options?: ObjectEncodingOptions & { withFileTypes?: false } | BufferEncoding | null): string[] | Buffer[];
    ...
    export function readFile(
        path: PathOrFd,
        options: ObjectEncodingOptions & { flag?: string; } & Abortable | string | undefined | null,
    ...
    export namespace readFile {
         ...
         * If a flag is not provided, it defaults to `'r'`.
         */
        function __promisify__(path: PathOrFd, options?: { encoding?: null; flag?: string; } | null): Promise<Buffer>;
         ...
         * If a flag is not provided, it defaults to `'r'`.
         */
        function __promisify__(path: PathOrFd, options: { encoding: BufferEncoding; flag?: string; } | string): Promise<string>;
         ...
         * If a flag is not provided, it defaults to `'r'`.
         */
        function __promisify__(path: PathOrFd, options?: ObjectEncodingOptions & { flag?: string; } | string | null): Promise<string | Buffer>;
    }
     ...
     */
    export function readFileSync(path: PathOrFd, options?: { encoding?: null; flag?: string; } | null): Buffer;
     ...
     * If a flag is not provided, it defaults to `'r'`.
     */
    export function readFileSync(path: PathOrFd, options: { encoding: BufferEncoding; flag?: string; } | BufferEncoding): string;
     ...
     * If a flag is not provided, it defaults to `'r'`.
     */
    export function readFileSync(path: PathOrFd, options?: ObjectEncodingOptions & { flag?: string; } | BufferEncoding | null): string | Buffer;

    export type WriteFileOptions = (ObjectEncodingOptions & Abortable & { mode?: Mode; flag?: string; }) | string | null;
