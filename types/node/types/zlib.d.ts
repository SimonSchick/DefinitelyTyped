declare module "zlib" {
    ...
    interface Gzip extends Transform, Zlib { }
    interface Gunzip extends Transform, Zlib { }
    interface Deflate extends Transform, Zlib, ZlibReset, ZlibParams { }
    interface Inflate extends Transform, Zlib, ZlibReset { }
    interface DeflateRaw extends Transform, Zlib, ZlibReset, ZlibParams { }
    interface InflateRaw extends Transform, Zlib, ZlibReset { }
    interface Unzip extends Transform, Zlib { }
