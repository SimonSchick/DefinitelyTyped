declare module "tls" {
    ...
    interface ConnectionOptions extends SecureContextOptions {
        ...
        socket?: Socket; // Establish secure connection on a given socket rather than creating a new socket
    ...
    function createSecurePair(credentials?: Credentials, isServer?: boolean, requestCert?: boolean, rejectUnauthorized?: boolean): SecurePair;
