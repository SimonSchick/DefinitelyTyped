declare module "child_process" {
    ...
    interface SpawnOptions extends BaseOptions {
        argv0?: string;
        stdio?: StdioOptions;
        detached?: boolean;
    ...
    interface ExecFileOptions extends BaseOptions {
        timeout?: number;
        maxBuffer?: number;
        killSignal?: string;
        windowsVerbatimArguments?: boolean;
    ...
    interface SpawnSyncOptions extends ExecFileOptions {
    ...
    interface ExecSyncOptions extends BaseOptions {
    ...
    interface ExecFileSyncOptions extends BaseOptions {
        input?: string | Buffer | NodeJS.TypedArray | DataView;
        stdio?: StdioOptions;
        timeout?: number;
        killSignal?: string | number;
