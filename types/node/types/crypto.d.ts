declare module "crypto" {
    import { TransformOptions, WritableOptions } from "stream";
    ...
    function createHash(algorithm: string, options?: TransformOptions): Hash;
    function createHmac(algorithm: string, key: string | Buffer | NodeJS.TypedArray | DataView, options?: TransformOptions): Hmac;
    ...
    /** @deprecated since v10.0.0 use createCipheriv() */
    function createCipher(algorithm: string, password: string | Buffer | NodeJS.TypedArray | DataView, options?: TransformOptions): Cipher;
    ...
    function createCipheriv(algorithm: string, key: string | Buffer | NodeJS.TypedArray | DataView, iv: string | Buffer | NodeJS.TypedArray | DataView, options?: TransformOptions): Cipher;
    ...
    /** @deprecated since v10.0.0 use createCipheriv() */
    function createDecipher(algorithm: string, password: string | Buffer | NodeJS.TypedArray | DataView, options?: TransformOptions): Decipher;
    ...
    function createDecipheriv(algorithm: string, key: string | Buffer | NodeJS.TypedArray | DataView, iv: string | Buffer | NodeJS.TypedArray | DataView, options?: TransformOptions): Decipher;
    ...
    function createSign(algorithm: string, options?: WritableOptions): Signer;
    ...
    function createVerify(algorith: string, options?: WritableOptions): Verify;
